...
// Bot invite URL
const BOT_INVITE_URL = 'https://discord.com/oauth2/authorize?client_id=1461409719330541761&permissions=93248&integration_type=0&scope=bot+applications.commands';
...
function renderLoggedOut() {
    // Header login button
    headerActions.innerHTML = `
        <a href="/auth/login" class="btn-primary" style="padding: 10px 20px; font-size: 0.95rem;">
            ${discordIcon}
            تسجيل الدخول
        </a>
    `;
